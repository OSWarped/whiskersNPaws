...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/prisma.ts [app-route] (ecmascript)"); // Adjust the path as needed
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/jwt.ts [app-route] (ecmascript)");
;
;
;
;
async function POST(request) {
    try {
        ...
        const { firstName, lastName, email, password, addressLine1, addressLine2, city, state, zip, phone } = await request.json();
        // Validate input
        ...
        // ✅ Generate a token
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signJwt"])({
            id: newUser.id,
            email: newUser.email
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__864738._.js.map